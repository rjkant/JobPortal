    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 700, color: 'white', marginBottom: '6px' }}>Create account</h1>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  required
                  placeholder="Rajnikant Kumar Gupta"
                  style={{
                    width: '100%',
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: 'rgba(255,255,255,0.4)' }}>
          ...
          <Link href="/login" style={{ color: 'hsl(258,90%,75%)', textDecoration: 'none', fontWeight: 500 }}>
            Sign in
          </Link>
        </p>
      </div>
